...
import DataService from '@/services/AnnouncementService'
...
const rules = {
  ...
  image: { required },
  content: {
    required: helpers.withMessage('Duyuru İçeriği boş olamaz', required),
  },
  extraFiles: {},
  extraImages: {},
  date: { required },
...
const createFailToast = (title, error) => {
  toasts.value.push({
    ...
    content: `Duyuru '${title}' eklenmedi. ${error}`,
  })
}
...
<template>
  ...
  <CRow>
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
          <strong>Yeni Duyuru Ekle</strong>
        </CCardHeader>
        <CCardBody>
          <CForm
            ref="formRef"
          ...
          >
            <div class="mb-3">
              <CFormLabel>Duyuru Başlığı</CFormLabel>
              <CFormInput
                type="text"
                ref="firstRef"
            ...
            <div class="mb-3">
              <CFormLabel>Duyuru Görseli</CFormLabel>
              <CFormInput
                type="file"
            ...
            <div class="mb-3">
              <CFormLabel>Duyuru İçeriği </CFormLabel>
              <ckeditor
            ...
            <div class="mb-3">
              <CFormLabel>Duyuru Tarihi</CFormLabel>
              <CFormInput
                type="date"
                v-model="data.date"
            ...
            <div class="mb-3">
              <CFormLabel>Duyuru Dosyaları Ekle</CFormLabel>
              <CFormInput
                type="file"
                multiple
            ...
            <div class="mb-3">
              <CFormLabel>Duyuru Fotoğrafları Ekle</CFormLabel>
              <CFormInput
                type="file"
                accept="image/png, image/gif, image/jpeg"
                multiple
            ...
            <CButton color="primary">Duyuru Ekle</CButton>
          </CForm>
        </CCardBody>
      </CCard>
    </CCol>
