...
const handleSubmit = async () => {
  ...
  if (!vuelidate.value.$invalid) {
    ...
    ModalService.create(data.value)
      .then(() => {
        loading.value = false
        createSuccessToast()
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          >
            ...
            <CButton color="primary">Modal Ekle</CButton>
          </CForm>
        </CCardBody>
      </CCard>
    </CCol>
